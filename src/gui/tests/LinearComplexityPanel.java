 ...
 * @author kenanince
 */
public class LinearComplexityPanel implements TestPanel{
	
	private JPanel panel;
	private JLabel label;
	private JSpinner value;

	public LinearComplexityPanel() {
	}
	...
	public JLabel getLabel() {
		if ( this.label == null ) {
			this.label = new JLabel("M (Block Length): ");
	...
	public JSpinner getValue() {
		if (this.value == null) {
			SpinnerModel sm = new SpinnerNumberModel(500, //initial value  
							500, //minimum value  
							5000, //maximum value  
							1); //step  
